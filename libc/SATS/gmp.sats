...
fun mpz_addmul3_ui
  (x: &mpz_vt, y: &mpz_vt, z: ulint):<> void = "#atslib_mpz_addmul3_ui"
overload mpz_addmul with mpz_addmul3_ui
...
fun mpz_submul3_ui
  (x: &mpz_vt, y: &mpz_vt, z: ulint):<> void = "#atslib_mpz_submul3_ui"
overload mpz_submul with mpz_submul3_ui
