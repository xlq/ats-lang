...
// int    ffs(int); // find first (least significant) bit set in a word
...
// if no bit is set
fun ffs (i: int): [n:int | n >= 0] int n
  = "atslib_ffs"

(* ****** ****** *)

// string comparison like [strcmp] but case is ignored
fun strcasecmp (str1: string, str2: string): int
  = "atslib_strcasecmp"

// string comparison like [strncmp] but case is ignored
