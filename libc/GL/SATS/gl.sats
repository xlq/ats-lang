...
fun int_of_GLenum (x: GLenum): int = "atslib_int_of_GLenum"

fun GLint_of_int (x: int): GLint = "atslib_GLint_of_int"
fun GLfloat_of_double (x: double): GLfloat = "atslib_GLfloat_of_double"
fun GLsizei_of_int (x: int): GLsizei = "atslib_GLsizei_of_int"

fun lor_GLbitfield_GLbitfield (b1: GLbitfield, b2: GLbitfield): GLbitfield
  = "atslib_lor_GLbitfield_GLbitfield"
...
fun glClearIndex(c: GLfloat): void = "atslib_glClearIndex"
...
fun glClear (mask: GLbitfield): void = "atslib_glClear"

fun glIndexMask (mask: GLuint): void = "atslib_glIndexMask"

fun glColorMask (red: GLboolean, green: GLboolean, blue: GLboolean, alpha: GLboolean): void
  = "atslib_glColorMask"

fun glAlphaFunc (func: GLenum, ref: GLclampf): void = "atslib_glAlphaFunc"

fun glBlendFunc (sfactor: GLenum, dfactor: GLenum): void = "atslib_glBlendFunc"

fun glLogicOp (opcode: GLenum): void = "atslib_glLogicOp"

fun glCullFace (mode: GLenum): void = "atslib_glCullFace"

fun glFrontFace (mode: GLenum): void  = "atslib_glFrontFace"

//

symintr glPointSize
fun glPointSize_double (width: double): void = "atslib_glPointSize_double"
fun glPointSize_GLfloat (width: GLfloat): void = "atslib_glPointSize_GLfloat"
...
symintr glLineWidth
fun glLineWidth_double (width: double): void = "atslib_glLineWidth_double"
fun glLineWidth_GLfloat (width: GLfloat): void = "atslib_glLineWidth_GLfloat"
overload glLineWidth with glLineWidth_double
overload glLineWidth with glLineWidth_GLfloat

//

fun glLineStipple (factor: GLint, pattern: GLushort): void = "atslib_glLineStipple"

fun glPolygonMode (face: GLenum, mode: GLenum): void = "atslib_glPolygonMode"

fun glPolygonOffset (factor: GLfloat, units: GLfloat): void = "atslib_glPolygonOffset"

// fun glPolygonStipple (const GLubyte *mask);

// fun glGetPolygonStipple (GLubyte *mask);

fun glEdgeFlag (flag: GLboolean): void = "atslib_glEdgeFlag"
...
fun glGetClipPlane {l:addr}
  (pf: array_v (GLdouble?, 4, l) | plane: GLenum, eqn: ptr l): void
  = "atslib_glGetClipPlane"

fun glDrawBuffer (mode: GLenum): void = "atslib_glDrawBuffer"

fun glReadBuffer (mode: GLenum): void = "atslib_glReadBuffer"

fun glEnable (cap: GLenum): void = "atslib_glEnable"

fun glDisable (cap: GLenum): void = "atslib_glDisable"

fun glIsEnabled (cap: GLenum): GLboolean = "atslib_GLboolean"

// version 1.1
fun glEnableClientState (cap: GLenum): void = "atslib_glEnableClientState"

// version 1.1
fun glDisableClientState (cap: GLenum): void = "atslib_glDisableClientState"
...
fun glPushAttrib (mask: GLbitfield): void = "atslib_glPushAttrib"

fun glPopAttrib (): void = "atslib_glPopAttrib"

// version 1.1
fun glPushClientAttrib (mask: GLbitfield): void = "atslib_glPushClientAttrib"

// version 1.1
fun glPopClientAttrib (): void = "atslib_glPopClientAttrib"

fun glRenderMode (mode: GLenum): GLint = "atslib_glRenderMode"
fun glGetError (): GLenum = "atslib_glGetError"

fun glGetString (name: GLenum): string = "atslib_glGetString"

fun glFinish (): void = "atslib_glFinish"

fun glFlush (): void = "atslib_glFlush"

fun glHint (target: GLenum, mode: GLenum): void = "atslib_glHint"

(* ****** ****** *)

// Depth Buffer

fun glClearDepth (depth: GLclampd): void = "atslib_glClearDepth"

fun glDepthFunc (func: GLenum): void = "atslib_glDepthFunc"

fun glDepthMask (flag: GLboolean): void = "atslib_glDepthMask"
...
fun glAccum (opr: GLenum, value: GLfloat): void = "atslib_glAccum"
...
fun glIsList (lst: GLuint): GLboolean = "atslib_glIsList"

fun glDeleteList {n:nat} (pf: GLlist_v n | lst: uint n): void
  = "ats_glDeleteList"

// fun glDeleteLists (lst: GLuint, range: GLsizei): void = "atslib_glDeleteLists"

fun glGenList_exn (): [n:nat] @(GLnewlist_v n | uint n) = "atslib_glGenList_exn"

// fun glGenLists (range: GLsizei): GLuint = "atslib_glGenLists"
...
fun glCallList {n:nat}
  (pf: !GLlist_v n | lst: uint n): void = "atslib_glCallList"
...
fun glNormal3b (nx: GLbyte, ny: GLbyte, nz: GLbyte): void = "atslib_glNormal3b"
fun glNormal3d (nx: GLdouble, ny: GLdouble, nz: GLdouble): void = "atslib_glNormal3d"
fun glNormal3f (nx: GLfloat, ny: GLfloat, nz: GLfloat): void = "atslib_glNormal3f"
fun glNormal3i (nx: GLint, ny: GLint, nz: GLint): void = "atslib_glNormal3i"
fun glNormal3s (nx: GLshort, ny: GLshort, nz: GLshort): void = "atslib_glNormal3s"
...
fun glIndexd (c: GLdouble): void = "atslib_glIndexd"
fun glIndexf (c: GLfloat): void = "atslib_glIndexf"
fun glIndexi (c: GLint): void = "atslib_glIndexi"
fun glIndexs (c: GLshort): void = "atslib_glIndexs"
fun glIndexub (c: GLubyte): void = "atslib_glIndexub" // OpenGL 1.1
...
fun glTexCoord1d (s: GLdouble): void = "atslib_glTexCoord1d"
fun glTexCoord1f (s: GLfloat): void = "atslib_glTexCoord1f"
fun glTexCoord1i (s: GLint): void = "atslib_glTexCoord1i"
fun glTexCoord1s (s: GLshort): void = "atslib_glTexCoord1s"

fun glTexCoord2d (s: GLdouble, t: GLdouble): void = "atslib_glTexCoord2d"
fun glTexCoord2f (s: GLfloat, t: GLfloat): void = "atslib_glTexCoord2f"
fun glTexCoord2i (s: GLint, t: GLint): void = "atslib_glTexCoord2i"
fun glTexCoord2s (s: GLshort, t: GLshort): void = "atslib_glTexCoord2s"

fun glTexCoord3d (s: GLdouble, t: GLdouble, r: GLdouble): void = "atslib_glTexCoord3d"
fun glTexCoord3f (s: GLfloat, t: GLfloat, r: GLfloat): void = "atslib_glTexCoord3f"
fun glTexCoord3i (s: GLint, t: GLint, r: GLint): void = "atslib_glTexCoord3i"
fun glTexCoord3s (s: GLshort, t: GLshort, r: GLshort): void = "atslib_glTexCoord3s"

fun glTexCoord4d (s: GLdouble, t: GLdouble, r: GLdouble, q: GLdouble): void = "atslib_glTexCoord4d"
fun glTexCoord4f (s: GLfloat, t: GLfloat, r: GLfloat, q: GLfloat): void = "atslib_glTexCoord4f"
fun glTexCoord4i (s: GLint, t: GLint, r: GLint, q: GLint): void = "atslib_glTexCoord4i"
fun glTexCoord4s (s: GLshort, t: GLshort, r: GLshort, q: GLshort): void = "atslib_glTexCoord4s"
...
fun glShadeModel (mode: GLenum): void = "atslib_glShadeModel"
...
fun glGetMaterialfv {n:nat} {l:addr}
  (pf: !array_v (GLfloat?, n, l) | face: GLenum, pname: GLenum, params: ptr l): void
  = "atslib_glGetMaterialfv"

fun glGetMaterialiv {n:nat} {l:addr}
  (pf: !array_v (GLint?, n, l) | face: GLenum, pname: GLenum, params: ptr l): void
  = "atslib_glGetMaterialiv"

(* ****** ****** *)

fun glColorMaterial (face: GLenum, mode: GLenum): void = "atslib_glColorMaterial"
