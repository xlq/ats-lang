...
%%%%%%
\input{naming_and_environment_1.dats}
%%%%%%
...
%%%%%%
\input{naming_and_environment_2.dats}
%%%%%%
...
\input{local_binding_example_1.dats}
...
follows:
\input{local_binding_example_2.dats}
...
\input{fibonacci_function_1.dats}
...
\input{isEvenOdd_functions.dats}
...
the radius of the circle is given: \input{area_of_circle_function.dats}
...
follows:
%%%%%%
\input{boxed_record_example_1.dats}
%%%%%%
The following is an example involving flat records.
%%%%%%
\input{flat_record_example_1.dats}
%%%%%%
...
As another example, a datatype involving non-unary data constructors is
given as follows:
\begin{verbatim}
datatype exp =
...
\input{list0_append_function.dats}
...
\begin{figure}[thp]
\input{binary_tree_is_perfect_function.dats}
...
\begin{figure}[thp]
\input{multiplication_table_function.dats}
