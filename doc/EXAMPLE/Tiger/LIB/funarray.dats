...
extern fun{a:t@ype} funarray_foreach_cloref {v:view} {n:nat}
 (pf: !v | A: farr (a, n), n: int n, f:  (!v | a) -<cloref> void):<!ref> void

extern fun{a:t@ype} funarray_iforeach_clo {v:view} {n:nat}
 (pf: !v | A: farr (a, n), n: int n, f: &(!v | natLt n, a) -<clo> void):<> void

extern fun{a:t@ype} funarray_iforeach_cloref {v:view} {n:nat}
 (pf: !v | A: farr (a, n), n: int n, f:  (!v | natLt n, a) -<cloref> void):<!ref> void
...
implement{a} funarray_foreach_cloref {v} {n} (pf | A, n, f) = let
  var i: natLte n
in
  for* {i:nat | i <= n} .<n-i>. // termination metric
    (i: int i) => (i := 0; i < n; i := i+1) f (pf | A[i])
...
implement{a} funarray_iforeach_cloref {v} {n} (pf | A, n, f) = let
  var i: natLte n
in
  for* {i:nat | i <= n} .<n-i>. // termination metric
    (i: int i) => (i := 0; i < n; i := i+1) f (pf | i, A[i])
