...
fun ignodeinfo_intset_set
  (info: ignodeinfo_t, intset: tempset_t): void
...
fun ignodeinfo_movset_set
  (info: ignodeinfo_t, movset: tempset_t): void
...
fun igraph_search_low (ig: igraph_t): Option_vt ($TL.temp_t)
