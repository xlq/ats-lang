...
// __assert (0.0 <= CHUNK_SWEEP_CUTOFF_PERCENT)
// __assert (CHUNK_SWEEP_CUTOFF_PERCENT <= 1.0)
__define CHUNK_LIMIT_EXTEND_CUTOFF 0.75 // 75%
// __assert (0.0 <= CHUNK_LIMIT_EXTEND_CUTOFF_PERCENT)
// __assert (CHUNK_LIMIT_EXTEND_CUTOFF_PERCENT <= 1.0)
