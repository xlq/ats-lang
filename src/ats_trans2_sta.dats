...
implement s1expopt_tr_dn_impredicative (os1e) = case+ os1e of
...
implement s1qualstlst_tr (s1qss) = begin case+ s1qss of
...
implement s1rtdeflst_tr (ds): void = begin case+ ds of
