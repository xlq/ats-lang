...
implement Timer_init (obj) = begin
...
implement Timer_getTicks (obj) =
  if (obj.private.started) then
    if (obj.private.paused) then obj.private.pausedTicks
    else _GetTicks() - obj.private.startTicks
  else 0 // end of [if]
