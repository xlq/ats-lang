...
fun gtk_text_view_new (): GtkTextView_ref1 = "#atsctrb_gtk_text_view_new"

//
// HX-2010-05-03: if [NULL] is passed, a new one is created automatically
//
fun gtk_text_view_new_with_buffer
  {c:cls | c <= GtkTextBuffer} {l:addr} (tb: !gobjref (c, l)): GtkTextView_ref1
...
fun gtk_text_view_set_buffer
  ...
  (tv: !gobjref (c1, l1), tb: !gobjref (c2, l2)): void = "#atsctrb_gtk_text_view_set_buffer"
...
fun gtk_text_view_get_buffer
  ...
  (tv: !gobjref (c, l)):<> [l_buf:agz] (
    minus (gobjref (c, l), gobjref (GtkTextBuffer, l_buf)) | gobjref (GtkTextBuffer, l_buf)
...
fun gtk_text_view_set_editable
  {c:cls | c <= GtkTextView} {l:agz}
  (tv: !gobjref (c, l), editable: gboolean): void = "#atsctrb_gtk_text_view_set_editable"
...
fun gtk_text_view_get_cursor_visible
  {c:cls | c <= GtkTextView} {l:agz}
  (tv: !gobjref (c, l)): gboolean = "#atsctrb_gtk_text_view_get_cursor_visible"
// end of [gtk_text_view_get_cursor_visible]

fun gtk_text_view_set_cursor_visible
  {c:cls | c <= GtkTextView} {l:agz}
  (tv: !gobjref (c, l), visible: gboolean): void = "#atsctrb_gtk_text_view_set_cursor_visible"
