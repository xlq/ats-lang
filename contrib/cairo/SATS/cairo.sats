...
fun cairo_create {l:addr}
  (sf: !cairo_surface_ref l): cairo_ref
  = "#atsctrb_cairo_create"

fun cairo_reference
  {l:addr} (cr: !cairo_ref l): cairo_ref l
  = "#atsctrb_cairo_reference"

fun cairo_destroy (cr: cairo_ref): void
  = "#atsctrb_cairo_destroy"

fun cairo_status {l:addr} (cr: !cairo_ref l): cairo_status_t
  = "#atsctrb_cairo_status"

(* ****** ****** *)

fun cairo_save {l:addr}
  (cr: !cairo_ref l): (cairo_save_v l | void)
  = "#atsctrb_cairo_save"

fun cairo_restore {l:addr}
  (pf: cairo_save_v l | cr: !cairo_ref l): void
...
fun cairo_get_target1
  {l:addr} (cr: !cairo_ref l): cairo_surface_ref
...
fun cairo_pop_group {l:addr}
  (pf: cairo_push_group_v l | cr: !cairo_ref l): cairo_pattern_ref
  = "#atsctrb_cairo_pop_group"

fun cairo_pop_group_to_source {l:addr}
  (pf: cairo_push_group_v l | cr: !cairo_ref l): void
  = "#atsctrb_cairo_pop_group_to_source"

(* ****** ****** *)

fun cairo_set_source_rgb {l:addr} (
    cr: !cairo_ref l
...
fun cairo_set_source_rgba {l:addr} (
    cr: !cairo_ref l
...
fun cairo_get_source {l:addr}
  (cr: !cairo_ref l): cairo_pattern_ref
  = "#atsctrb_cairo_get_source"

fun cairo_set_source {l1,l2:addr}
...
fun cairo_set_fill_rule
  {l:addr} (cr: !cairo_ref l, fill_rule: cairo_fill_rule_t): void
...
fun cairo_get_line_cap
  {l:addr} (cr: !cairo_ref l): cairo_line_cap_t
  = "#atsctrb_cairo_get_line_cap"

fun cairo_set_line_cap
  {l:addr} (cr: !cairo_ref l, line_cap: cairo_line_cap_t): void
...
fun cairo_get_line_join
  {l:addr} (cr: !cairo_ref l): cairo_line_join_t
  = "#atsctrb_cairo_get_line_join"

fun cairo_set_line_join
  {l:addr} (cr: !cairo_ref l, line_join: cairo_line_join_t): void
  = "#atsctrb_cairo_set_line_join"

(* ****** ****** *)

fun cairo_get_line_width {l:addr} (cr: !cairo_ref l): double
  = "#atsctrb_cairo_get_line_width"

fun cairo_set_line_width {l:addr} (cr: !cairo_ref l, width: double): void
  = "#atsctrb_cairo_set_line_width"
                                                         
(* ****** ****** *)

fun cairo_get_miter_limit {l:addr} (cr: !cairo_ref l): double
  = "#atsctrb_cairo_get_miter_limit"

fun cairo_set_miter_limit {l:addr} (cr: !cairo_ref l, width: double): void
...
fun cairo_get_operator
  {l:addr} (cr: !cairo_ref l): cairo_operator_t
  = "#atsctrb_cairo_get_operator"

fun cairo_set_operator
  {l:addr} (cr: !cairo_ref l, operator: cairo_operator_t): void
  = "#atsctrb_cairo_set_operator"

(* ****** ****** *)

fun cairo_get_tolerance {l:addr} (cr: !cairo_ref l): double
  = "#atsctrb_cairo_get_tolerance"

fun cairo_set_tolerance {l:addr} (cr: !cairo_ref l, tolerance: double): void
...
fun cairo_copy_clip_rectangle_list
  {l:addr} (cr: !cairo_ref l): [n:nat] cairo_rectangle_list_ref (n)
  = "#atsctrb_cairo_copy_clip_rectangle_list"

(* ****** ****** *)

fun cairo_clip {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_clip"

fun cairo_clip_preserve {l:addr} (cr: !cairo_ref l): void
...
fun cairo_reset_clip {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_reset_clip"

(* ****** ****** *)

fun cairo_fill {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_fill"

fun cairo_fill_preserve {l:addr} (cr: !cairo_ref l): void
...
fun cairo_paint {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_paint"

fun cairo_paint_with_alpha
  {l:addr} (cr: !cairo_ref l, alpha: double): void
  = "#atsctrb_cairo_paint_with_alpha"

(* ****** ****** *)

fun cairo_stroke {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_stroke"

fun cairo_stroke_preserve {l:addr} (cr: !cairo_ref l): void
...
// [cairo_bool_t] and [bool] are the same
fun cairo_in_stroke {l:addr} (cr: !cairo_ref l, x: double, y: double): bool
  = "#atsctrb_cairo_in_stroke"

(* ****** ****** *)

fun cairo_get_reference_count {l:addr} (cr: !cairo_ref l): uint
  = "#atsctrb_cairo_get_reference_count"

(* ****** ****** *)

fun cairo_copy_page {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_copy_page"

fun cairo_show_page {l:addr} (cr: !cairo_ref l): void
...
fun cairo_get_user_data {l:addr} (
...
fun cairo_copy_path
  {l:addr} (cr: !cairo_ref l): [n:nat] cairo_path_ref n
...
fun cairo_append_path {l:addr} {n:nat}
...
// [cairo_bool_t] and [bool] are the same
fun cairo_has_current_point {l:addr} (cr: !cairo_ref l): bool
  = "#atsctrb_cairo_has_current_point"

fun cairo_get_current_point {l:addr} (
...
fun cairo_new_path {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_new_path"

fun cairo_new_sub_path {l:addr} (cr: !cairo_ref l): void
  = "#atsctrb_cairo_new_path"

fun cairo_close_path {l:addr} (cr: !cairo_ref l): void
...
fun cairo_line_to
  {l:addr} (cr: !cairo_ref l, x: double, y: double): void
...
fun cairo_rel_line_to
  {l:addr} (cr: !cairo_ref l, dx: double, dy: double): void
...
fun cairo_get_font_face
  {l:addr} (cr: !cairo_ref l): cairo_font_face_ref
  = "#atsctrb_cairo_get_font_face"

fun cairo_set_font_face {l1,l2:addr}
...
fun cairo_toy_font_face_get_family
  {l:addr} (font_face: !cairo_font_face_ref l): string
  = "#atsctrb_cairo_toy_font_face_get_family"

fun cairo_toy_font_face_get_slant
  {l:addr} (font_face: !cairo_font_face_ref l): cairo_font_slant_t
  = "#atsctrb_cairo_toy_font_face_get_slant"

fun cairo_toy_font_face_get_weight
  {l:addr} (font_face: !cairo_font_face_ref l): cairo_font_weight_t
...
fun cairo_translate {l:addr}
  (cr: !cairo_ref l, x: double, y: double): void
  = "#atsctrb_cairo_translate"

fun cairo_scale {l:addr}
  (cr: !cairo_ref l, sx: double, sy: double): void
  = "#atsctrb_cairo_scale"

fun cairo_rotate {l:addr} (cr: !cairo_ref l, angle: double): void
  = "#atsctrb_cairo_rotate"

fun cairo_transform {l:addr}
  (cr: !cairo_ref l, mat: &cairo_matrix_t): void
...
fun cairo_set_matrix
  {l:addr} (cr: !cairo_ref l, mat: &cairo_matrix_t): void
  = "#atsctrb_cairo_set_matrix"
  
fun cairo_identity_matrix {l:addr} (cr: !cairo_ref l): void
...
fun cairo_font_face_reference
  {l:addr} (font_face: !cairo_font_face_ref l): cairo_font_face_ref l
...
fun cairo_font_face_status
  {l:addr} (font_face: !cairo_font_face_ref l): cairo_status_t
...
fun cairo_font_face_get_type
  {l:addr} (font_face: !cairo_font_face_ref l): cairo_font_type_t
  = "#atsctrb_cairo_font_face_get_type"

fun cairo_font_face_get_reference_count
  {l:addr} (font_face: !cairo_font_face_ref l): uint
...
viewtypedef cairo_scaled_font_ref = [l:addr] cairo_scaled_font_ref l

fun cairo_scaled_font_reference
  {l:addr} (font: !cairo_scaled_font_ref l): cairo_scaled_font_ref
  = "#atsctrb_cairo_scaled_font_reference"

fun cairo_scaled_font_destroy
  {l:addr} (font: cairo_scaled_font_ref l): void
  = "#atsctrb_cairo_scaled_font_destroy"

fun cairo_scaled_font_status
  {l:addr} (font: !cairo_scaled_font_ref l): cairo_status_t
...
fun cairo_scaled_font_get_font_face
  {l:addr} (font: !cairo_scaled_font_ref l) : cairo_font_face_ref
  = "#atsctrb_cairo_scaled_font_get_font_face"

fun cairo_scaled_font_get_font_options
  {l:addr} (
    font: !cairo_scaled_font_ref l, options: !cairo_font_options_ptr
  ) : void
...
fun cairo_scaled_font_get_type
  {l:addr} (font: !cairo_scaled_font_ref l): cairo_font_type_t
  = "#atsctrb_cairo_scaled_font_get_type"

fun cairo_scaled_font_get_reference_count
  {l:addr} (font: !cairo_scaled_font_ref l): uint
...
fun cairo_image_surface_get_data
  {l:addr} (sf: !cairo_surface_ref l): Ptr // uchar*
  = "#atsctrb_cairo_image_surface_get_data"

fun cairo_image_surface_get_format
  {l:addr} (sf: !cairo_surface_ref l): cairo_format_t
  = "#atsctrb_cairo_image_surface_get_format"

fun cairo_image_surface_get_width {l:addr} (sf: !cairo_surface_ref l): Nat
  = "#atsctrb_cairo_image_surface_get_width"

fun cairo_image_surface_get_height {l:addr} (sf: !cairo_surface_ref l): Nat
  = "#atsctrb_cairo_image_surface_get_height"

fun cairo_image_surface_get_stride {l:addr} (sf: !cairo_surface_ref l): Nat
...
fun cairo_surface_write_to_png
  {l:addr} (sf: !cairo_surface_ref l, filename: string): cairo_status_t
  = "#atsctrb_cairo_surface_write_to_png"

fun cairo_surface_write_to_png_stream
  {v:view} {vt:viewtype} {l:addr} (
    pf: !v
  | sf: !cairo_surface_ref l
...
fun cairo_ps_surface_dsc_begin_setup
  {l:addr} (sf: !cairo_surface_ref l) : void
...
fun cairo_ps_surface_dsc_comment
  {l:addr} (sf: !cairo_surface_ref l, comment: string): void
...
fun cairo_svg_surface_restrict_to_version
  {l:addr} (cr: !cairo_ref l, version: cairo_svg_version_t): void
...
fun cairo_quartz_surface_get_cg_context
  {l:addr} (surface: !cairo_surface_ref l): CGContextRef
