...
fun clutter_actor_show
  ...
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_show"
// end of [clutter_actor_show]

fun clutter_actor_show_all
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_show_all"
...
fun clutter_actor_hide
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_hide"
// end of [clutter_actor_hide]

fun clutter_actor_hide_all
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_hide_all"
...
fun clutter_actor_map
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_map"
// end of [clutter_actor_map]

fun clutter_actor_unmap
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_unmap"
...
fun clutter_actor_realize
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_realize"
// end of [clutter_actor_realize]

fun clutter_actor_unrealize
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_unrealize"
...
fun clutter_actor_paint
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_paint"
...
fun clutter_actor_queue_redraw
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_queue_redraw"
// end of [clutter_actor_queue_redraw]

fun clutter_actor_queue_relayout
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): void = "#atsctrb_clutter_actor_queue_relayout"
...
fun clutter_actor_get_width
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): gfloat = "#atsctrb_clutter_actor_get_width"
// end of [clutter_actor_get_width]

fun clutter_actor_set_width
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l), width: gfloat): void = "#atsctrb_clutter_actor_set_width"
// end of [clutter_actor_set_width]

fun clutter_actor_get_height
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l)): gfloat = "#atsctrb_clutter_actor_get_height"
// end of [clutter_actor_get_height]

fun clutter_actor_set_height
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l), height: gfloat): void = "#atsctrb_clutter_actor_set_height"
// end of [clutter_actor_set_height]

fun clutter_actor_get_size
  {c:cls | c <= ClutterActor} {l:agz} (
    self: !gobjref (c, l), w: &gfloat? >> gfloat, h: &gfloat? >> gfloat
  ) : void = "#atsctrb_clutter_actor_get_size"
// end of [clutter_actor_get_size]

fun clutter_actor_set_size
  {c:cls | c <= ClutterActor} {l:agz}
  (self: !gobjref (c, l), w: gfloat, h: gfloat): void = "#atsctrb_clutter_actor_set_size"
